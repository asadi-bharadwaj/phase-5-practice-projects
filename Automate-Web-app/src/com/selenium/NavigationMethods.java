...
String actualtitle = driver.getTitle(); // will fetch thetitle of the page
...
String title1 = driver.getTitle(); // will fetch the title of thepage
System.out.println("Title of Page2 =" + title1);
driver.navigate().back(); // navigates back to previousurl
Thread.sleep(2000);
